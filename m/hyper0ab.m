...
dallA = [dall ...
        sa .* (...
(-ca - ca3 - cb + cb5 - 2.*cb2.*ca - 3.*cb.*ca2 - 2.*cb2.*ca3 + 2.*cb4.*ca - cb.*ca4) .* (1 + ca2 + 2.*ca.*cb) .* (1 + cb2 + 2.*ca.*cb) .* sqrt(cb2 + ca2 + 2 .* cb .* ca + 1) + ...
-cb .* ca .* (1 + ca2 + cb2 + 4.*ca.*cb + 5.* ca2.*cb2 + 2 .* cb .*ca3 + 2.*ca.*cb3) .* sqrt(6.*ca2.*cb2 + 2.*ca.*cb + ca4 + cb4 + ca2 + cb2 + 4.*ca3.*cb + 4.*ca.*cb3) .* (1 + ca2 + 2.*ca.*cb) + ...
- (1 + ca2 + 3.*ca.*cb  + cb2) .* (1 + ca2 + cb2 + 4.*ca.*cb + 5.* ca2.*cb2 + 2 .* cb .*ca3 + 2.*ca.*cb3) .* sqrt(6.*ca2.*cb2 + 2.*ca.*cb + ca4 + cb4 + ca2 + cb2 + 4.*ca3.*cb + 4.*ca.*cb3) .* (1 + cb2 + 2.*ca.*cb)) ...
  ./ ...
((1 + ca2 + cb2 + 4.*ca.*cb + 5.* ca2.*cb2 + 2 .* cb .*ca3 + 2.*ca.*cb3) .* sqrt(6.*ca2.*cb2 + 2.*ca.*cb + ca4 + cb4 + ca2 + cb2 + 4.*ca3.*cb + 4.*ca.*cb3) .* (1 + cb2 + 2.*ca.*cb) .* (1 + ca2 + 2.*ca.*cb) .* sqrt(cb2 + ca2 + 2 .* cb .* ca + 1))...
];
